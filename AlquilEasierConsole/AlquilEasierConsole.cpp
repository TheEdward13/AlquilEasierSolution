...
int main(array<System::String ^> ^args)
{
    ...
    HabitacionMantenimiento^ habitacionmantenimiento = gcnew HabitacionMantenimiento();

    habitacionmantenimiento->estaLimpio = true;
    habitacionmantenimiento->NumDepa = 101;
    habitacionmantenimiento->Id = 101;
    habitacionmantenimiento->Estado = "Limpio";


    Service::AddHabitacionLimpia(habitacionmantenimiento);
