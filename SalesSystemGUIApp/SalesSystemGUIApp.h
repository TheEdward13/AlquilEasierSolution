...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->ItemClicked += gcnew System::Windows::Forms::ToolStripItemClickedEventHandler(this, &SalesSystemMainForm::menuStrip1_ItemClicked);
			// 
			...
			this->archivoToolStripMenuItem->Click += gcnew System::EventHandler(this, &SalesSystemMainForm::archivoToolStripMenuItem_Click);
			// 
